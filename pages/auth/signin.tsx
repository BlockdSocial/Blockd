            ...
            <div className="h-screen hidden md:flex items-center w-full md:w-1/2 lg:w-1/2 xl:w-1/2">
                <div className="flex items-center w-full">
                    <div className="h-full w-full rounded-2xl p-10 ml-10 xl:ml-28">
                        ...
                        <button className="md:w-4/8 mt-8 bg-button2 text-white py-2 px-4 rounded-xl">Learn more</button>
                    </div>
                </div>
            </div>
            <div className="h-screen flex items-center w-full md:w-1/2 lg:w-1/2 xl:w-1/2 p-12">
                <div className="flex items-center h-1/2 w-full xl:w-3/4 rounded-2xl bg-color">
