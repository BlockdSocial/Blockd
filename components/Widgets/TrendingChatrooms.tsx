    ...
    return (
        <div className='p-2'>
            ...
            <div className='flex items-center justify-start'>
                <Link href="/trendingchatrooms" className='flex items-center justify-start bg-gray-100 hover:bg-gray-200 dark:hover:bg-darkgray dark:bg-lightgray rounded-md w-fit p-2 mt-1'>
                    <p className='font-semibold text-sm'>
                        Show more
                    </p>
                </Link>
