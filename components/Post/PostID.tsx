    ...
    <div className="flex flex-col p-4 -z-20 border-y dark:border-lightgray">
      ...
      <div className="w-full">
                  ...
                  >
                    ...
                    {post?.userId !== authUser?.id && (
                      <>
                        ...
                        <div
                          className="flex items-center text-sm justify-start p-3 hover:bg-gray-200 hover:rounded-md dark:hover:bg-darkgray/50"
        ...
        <div className="w-full flex flex-col items-start">
          <p className="pt-6 text-sm break-words whitespace-pre-line w-fit max-w-full">
