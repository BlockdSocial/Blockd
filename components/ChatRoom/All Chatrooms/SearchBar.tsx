...
function SearchBar() {
  return (
    <div className="flex items-center justify-between space-x-3 px-4 pt-4">
      <div className="w-1/2">
        <select className="rounded-lg w-full border-none outline-none text-black dark:text-white p-[11px] bg-gray-200 dark:bg-lightgray">
        <option className="outline-none p-2">All Networks</option>
