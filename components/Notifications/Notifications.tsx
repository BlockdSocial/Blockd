...
function Notifications() {
  return (
    <div className="divide-slate-200 dark:divide-lightgray">
      <Link href="/profile" className="flex items-center justify-between group/item border-b dark:border-lightgray hover:bg-slate-100 dark:hover:bg-lightgray p-4 cursor-pointer">
