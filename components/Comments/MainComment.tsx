                        ...
                        <div className='flex justify-between mt-2'>
                            <div className='flex'>
                                ...
                                <div className='flex cursor-pointer items-center space-x-1 ml-3 text-gray-400 hover:text-black dark:hover:text-white'>
                                    <ChatBubbleBottomCenterTextIcon onClick={() => setCommentBoxVisible(!commentBoxVisible)} className='h-4 w-4  cursor-pointer transition-transform ease-out duration-150 hover:scale-150' />
