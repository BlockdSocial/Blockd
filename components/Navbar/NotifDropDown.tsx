...
function NotifDropDown() {
    return (
        <div className="absolute w-100 h-40 right-20 top-16 mt-2 dark:border dark:border-white bg-white rounded-md shadow-lg scrollbar-hide overflow-scroll  z-20">
            <div className="py-2">
            ...
            <a href="/notifications" className="block bg-darkblue hover:bg-darkblue/80 dark:bg-gray-700 dark:hover:bg-gray-800 text-white dark:text-white text-center font-bold py-2">See all notifications</a>
        </div>
    )
}
