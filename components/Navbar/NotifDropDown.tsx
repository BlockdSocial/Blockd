...
function NotifDropDown() {
    return (
        <div className="absolute w-100 max-h-96 right-20 top-16 mt-2 dark:border dark:border-lightgray bg-white dark:bg-darkgray rounded-md shadow-lg scrollbar-hide overflow-scroll">
            <div className="">
