...
function NotifDropDown() {
    return (
        <div className="absolute w-100 h-48 right-20 top-16 mt-2 dark:border dark:border-white bg-white dark:bg-darkgray rounded-md shadow-lg scrollbar-hide overflow-scroll">
            <div className="">
