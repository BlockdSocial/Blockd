...
function MsgDropDown() {
    return (
        <div className="absolute h-48 w-100 right-32 top-16 mt-2 bg-white dark:border dark:border-white dark:bg-darkgray rounded-md shadow-lg scrollbar-hide overflow-scroll z-20">
            <div className="relative">
                <a href="#" className="flex items-center px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-lightgray -mx-2">
                ...
                <a href="#" className="flex items-center px-4 py-3 hover:bg-gray-100 dark:hover:bg-lightgray -mx-2">
