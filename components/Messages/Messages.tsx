...
function Messages() {
  return (
    <div className="divide-slate-200 dark:divide-lightgray">
      <Link href="/dashboard/profile" className="flex items-center justify-between p-4 group/item border-b dark:border-lightgray hover:bg-slate-100 dark:hover:bg-lightgray cursor-pointer">
