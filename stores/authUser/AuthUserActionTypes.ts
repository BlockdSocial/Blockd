...
export const IS_SENDING_VERIFICATION = 'IS_SENDING_VERIFICATION';
...
export const IS_GENERATING_TOKEN = 'IS_GENERATING_TOKEN';
export const GENERATE_TOKEN_SUCCESS = 'GENERATE_TOKEN_SUCCESS';
export const GENERATE_TOKEN_FAILURE = 'GENERATE_TOKEN_FAILURE';
export const IS_RESENDING_VERIFICATION = 'IS_RESENDING_VERIFICATION';
